...
class CustomCNNADSADataGenerator(Sequence):
    param_mean = None
    param_std = None
    ...
    def __init__(self, dataset_path, split='train', batch_size=32, image_size=(512, 640),
        ...
        if CustomCNNADSADataGenerator.param_mean is None and split == 'train':
            ...
            CustomCNNADSADataGenerator.param_mean = params.mean(axis=0)
            CustomCNNADSADataGenerator.param_std = params.std(axis=0)
            print(f"[INFO] Computed normalization stats: mean={CustomCNNADSADataGenerator.param_mean}, std={CustomCNNADSADataGenerator.param_std}")
