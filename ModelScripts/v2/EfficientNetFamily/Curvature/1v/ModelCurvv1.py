...
def main():
    ...
    with open("Curv_Model_Large_ENF_V1_stats.json", "w") as f:
        json.dump(stats, f)
    ...
    plt.tight_layout()
    plt.savefig("training_curves_curv.png")
    plt.show()
    ...
    plt.title("Predicted vs True Values curve")
    plt.grid(True)
    plt.tight_layout()
