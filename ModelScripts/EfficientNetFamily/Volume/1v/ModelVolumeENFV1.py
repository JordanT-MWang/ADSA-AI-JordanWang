...
def main():
    ...
    with open("Volume_Model_Large_Cust_V1_stats.json", "w") as f:
        json.dump(stats, f)
    ...
    plt.tight_layout()
    plt.savefig("training_curves_Vol.png")
    plt.show()
    ...
    plt.xlabel("True Volume (ul)")
    plt.ylabel("Predicted Volume (ul)")
    plt.title("Predicted vs True Values")
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("pred_vs_true_Volume.png")
    plt.show()
