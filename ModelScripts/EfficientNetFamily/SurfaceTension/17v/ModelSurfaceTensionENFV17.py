...
def main():
    ...
    with open("SurfaceTension_Model_Large_Cust_V17_stats.json", "w") as f:
        json.dump(stats, f)
    ...
    # Save model
    model.save("SurfaceTensionENFv17.keras")
    ...
    plt.xlabel("True Surface Ten")
    plt.ylabel("Predicted Surface Ten")
