...
def create_model(input_image_shape=(512, 640, 3), input_param_size=2, freeze_until=250):
    """
...
def main():
    ...
    "best_SurfaceTensinoENFv6.keras",
    monitor="val_loss",
    save_best_only=True,
    ...
    with open("SurfaceTension_Model_Large_Cust_V6_stats.json", "w") as f:
        json.dump(stats, f)
    ...
    # Save model
    model.save("SurfaceTensionENFv6.keras")
