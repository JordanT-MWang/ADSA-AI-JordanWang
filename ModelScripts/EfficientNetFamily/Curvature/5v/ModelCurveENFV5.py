...
def create_model(input_image_shape=(512, 640, 3), input_param_size=2, freeze_until=120):
    """
...
def main():
    ...
    batch_size = 64
    model_name="SurfaceTensionENF5"
    image_size = (800, 800)
    checkpoint_cb = tf.keras.callbacks.ModelCheckpoint(
    "best_CurvaturENFv5.keras",
    monitor="val_loss",
    save_best_only=True,
    ...
    with open("Curve_Model_Large_ENF_V1_stats.json", "w") as f:
        json.dump(stats, f)
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("pred_vs_true_Curve.png")
    plt.show()
